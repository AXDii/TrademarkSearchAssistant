...
public class AttachedFilesActivity extends BaseActivity implements AdapterView.OnItemClickListener{

    private static final String TAG = "AttachedFilesActivity";
    private final static String File_Path = "goodsAndService/attachedFiles";
...
//        initAsrAndWakeUp();
        ...
        listView = (ListView)findViewById(R.id.attached_file_list);
