...
public class GraphicElementActivity extends BaseActivity {

    public static final String FILE_PATH = "graphicElement/图形要素.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graphic_element);
    ...
    public void showHtml() {
        ...
        webView = (WebView)findViewById(R.id.graphic_element);
