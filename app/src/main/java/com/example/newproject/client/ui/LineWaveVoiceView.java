...
import com.example.newproject.client.util.ThreadPool;
...
public class LineWaveVoiceView extends View {
    ...
    private static final String DEFAULT_TEXT = " 识别中..";
    private String text = DEFAULT_TEXT;
    private int textColor;
    private boolean isStart = false;
    private Runnable mRunable;
//    private static float maxAmp = 10;
    ...
    private static final int UPDATE_INTERVAL_TIME = 150;//100ms更新一次
    ...
    private synchronized void refreshElement() {
        ...
        float maxAmp = (float) Math.random();

        Log.d(TAG, "refreshElement: maxAmp " + maxAmp);
