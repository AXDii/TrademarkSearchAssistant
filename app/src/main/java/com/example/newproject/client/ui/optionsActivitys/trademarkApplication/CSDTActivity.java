...
public class CSDTActivity extends BaseActivity {

    public static final String FILE_PATH = "goodsAndService/商品和服务分类.html";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csdt);
    ...
    public void showHtml() {
        ...
        webView = (WebView)findViewById(R.id.goods_and_service);
