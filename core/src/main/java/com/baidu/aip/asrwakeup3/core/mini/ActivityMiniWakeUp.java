...
public class ActivityMiniWakeUp extends AppCompatActivity implements EventListener {
    ...
    private static final String TAG = "ActivityMiniWakeUp";
...
//        params.put(SpeechConstant.APP_ID, 15590577);
...
//        });
    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        Log.d(TAG, "onEvent: 识别到");
        Toast.makeText(this, "识别到了，响应到了", Toast.LENGTH_LONG).show();
    }
